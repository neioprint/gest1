            ...
            <div class="row">
                <section class="col-12">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="idclient" name="idclient" required>
                                    ...
                                    <option value="<?= $idclientt . '/' . $nomclient ?>" selected>
                                        <?= $idclientt . '/' . $nomclient ?>
                                    </option>
                            ...
                            <input value="<?= @$_POST['impclient']; ?>" minlength="5" type="text" id="impclient"
                                name="impclient" maxlength="20" class="form-control" required>
                        </div>
                        <!-- <div class="form-group">
                    ...
                    <input  name="idmat" class="form-control" placeholder="okokok" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" size="1" id="typ" name="typ" required>
                                <option value="" <?php if (@$typ == "")
                                    echo "selected" ?>>Selectionner une option
                                    </option>
                                    <!-- <option  value="0"> Selectionner un imprimé</option> -->
                                    <option value="carnet" <?php if (@$typ == "carnet")
                                    echo "selected" ?>> Carnet</option>
                                    <option value="ordonnance" <?php if (@$typ == "ordonnance")
                                    echo "selected" ?>> Ordonnance
                                        Médicale </option>
                                    <!-- <option value="bloc" < ?php if (@$typ == "bloc") echo "selected" ?>> Bloc ordonnance</option> -->
                                    <option value="feuille" <?php if (@$typ == "feuille")
                                    echo "selected" ?>> Feuille Volante
                                    </option>
                                    <option value="fiche" <?php if (@$typ == "fiche")
                                    echo "selected" ?>> Fiche </option>
                                    <option value="cartevisite" <?php if (@$typ == "cartevisite")
                                    echo "selected" ?>>Carte de
                                        visite</option>
                                    <option value="etiquette" <?php if (@$typ == "etiquette")
                                    echo "selected" ?>> Etiquette
                                    </option>
                                    <option value="affiche" <?php if (@$typ == "affiche")
                                    echo "selected" ?>> Affiche
                                    </option>
                                    <option value="poster" <?php if (@$typ == "poster")
                                    echo "selected" ?>> Poster </option>
                                    <option value="pochettearabat" <?php if (@$typ == "pochette")
                                    echo "selected" ?>>pochette
                                        à rabat</option>
                                    <option value="chemise" <?php if (@$typ == "chemise")
                                    echo "selected" ?>>Chemise</option>
                                    <option value="env" <?php if (@$typ == "env")
                                    echo "selected" ?>>Enveloppe</option>
                                    <option value="livret" <?php if (@$typ == "livret")
                                    echo "selected" ?>>Livret</option>
                                    <option value="catalogue" <?php if (@$typ == "catalogue")
                                    echo "selected" ?>>Catalogue
                                    </option>
                                    <option value="depliant" <?php if (@$typ == "depliant")
                                    echo "selected" ?>>depliant
                                    </option>
                                    <option value="flayer" <?php if (@$typ == "flayer")
                                    echo "selected" ?>>Flayer</option>
                                    <option value="calendrier" <?php if (@$typ == "calendrier")
                                    echo "selected" ?>>Calendrier
                                    </option>
                    ...
                    <option value="chevalet" < ?php if ($typ=="chevalet") echo "selected" ?>>Chevalet</option> -->
                                    <option value="boite" <?php if (@$typ == "boite")
                                    echo "selected" ?>> Boite pliante
                                    </option>
                                    <option value="conception" <?php if (@$typ == "conception")
                                    echo "selected" ?>> Conception
                                        maquette</option>
                                    <option value="reproduction" <?php if (@$typ == "reproduction")
                                    echo "selected" ?>>
                                        Reproduction maquette </option>
                                    <option value="autre" <?php if (@$typ == "autre")
                                    echo "selected" ?>> Autre .....
                                    </option>
                                </select>
                      ...
                      ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="matiere" name="matiere" required>
                                    ...
                                    <option value="extracouleur"> Papier blanc</option>
                ...
                <a class="btn btn-primary"
                    href="formclient.php?idclient=<?= $idclientt ?>&nomclient=<?= $nomclient ?>&quefaire=<?= $quefaire ?>&imprime=<?= $imprime_nouveau ?>">Retour
                sans valider</a>
