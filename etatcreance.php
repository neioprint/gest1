...
not (etat like '%5/Archivée%') and
not (etat like '%6/%') order by nomclient";
//"select * from commande order by nomclient";

//  $sql = "select nomclient,etat from commande order by nomclient,etat (not (etat like '%5/%') and not (etat like '%6/%'))";
    ...
    <main class="container">
        <div class="row">
            <section class="col-12">
                ...
                ?> -->
                <h1 class="entete">Etat Créances</h1>
                <br>
                ...
                <?php if (isset($_POST["client1"])) { ?>
                    <form name="fo" method="post">
                        ...
                        <!-- <input type="hidden" name="page" value="1" /> -->
                        <select class="form-control" id="commande" name="commande[]" multiple size="4">
                        ...
                        <input type="hidden" id="idclient" name="idclient" value="< ?= $client['id'] ?>" class="form-control" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="versement" value=<?= $datevalue ?> name="versement" class="form-control">
                            </div>
                            <div class="form-group">
            ...
            ?>
            <br>
            <a class="btn btn-success" href="indexcommande.php?page=1&recherche=&niveau=ins">Retour</a>
            </section>
