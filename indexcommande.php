...
if ($niveau == "ins") {
    if ($recherche=="") $sql = "select * from commande where  not(tag like '%11%') and
   ((etat like '%0/%' or etat like '%1/%' or etat like '%2/%'or etat like '%3/%') or (etat like '%6/%'  and dates>='$dat'))    order by dates";




   if ($recherche!="")  $sql = "select * from commande where not(tag like '%11%')  
     and ((etat like '%0/%' or etat like '%1/%' or etat like '%2/%') or (etat like '%6/%'  and dates>='$dat'))  
            ...
            <div class="panel-body">
                <form name="fo0" id="fo0" method="get" class="form-inline">
                    <div class="form-group">
                        ...
                        <?php if (@$date2 != @$datexx) $date2 = $datexx ?>
                ...
                <div class="table-responsive">
                    ...
                    <table class="mx-auto table tab table-striped table-responsive">
                        ...
                        <thead class="table">
                            ...
                            <th class="table-primary"><i class="fa fa-tag" style='font-size:<?= ICONFONT ?>;color:blue' aria-hidden="true"></i></th>
                                ...
                                <tr>
                                    ...
                                    <td class="table-primary">
                                        ...
                                        if ($etatcolor[0][0] == 3) { ?>
                                            ...
                                            if (array_key_exists(1, $etatclientseq)) echo '<span><i class="fa fa-user-circle" style="font-size:30px;color:blue" aria-hidden="true"></i></span>'; else
                                            if (array_key_exists(1, $etatclientdirect)) echo '<span><i class="fa fa-user-circle" style="font-size:30px;color:blue" aria-hidden="true"></i></span>';
                                            //$etatclientdirect[1]
                                            ?>
                                    </td>
                                    <?php
                                    ...
                                    <th class="table-primary">
                                        <?php if ($resultcommande[$i]['tag'] != 0) {
                                            if ($resultcommande[$i]['tag'] == 1) echo "<i class='fa fa-tag' style='font-size:30px;color:red'></i>";
                                            if ($resultcommande[$i]['tag'] == 11) echo "<i class='fa fa-tag' style='font-size:30px;color:blue'></i>";
                                            if ($resultcommande[$i]['tag'] == 10) echo "<i class='fa fa-tag' style='font-size:30px;color:black'></i>";
                                        }
                                        ?>
                                    ...
                                    $resultcommande[$i]['etat'] ?>&idclient=< ?= $resultcommande[$i]['idclient'] ?>">Action</a> -->
                                        ...
                                        <?php if (array_key_exists(1, $etatclientdirect)) echo $etatclientdirect[1];
                                            if (array_key_exists(1, $etatclientseq)) echo $etatclientseq[1];
