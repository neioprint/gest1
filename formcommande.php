...
if (isset($_POST["submit1"]) && !empty($_POST["submit1"])) {
    ...
    if (
        ...
        $sql = "SELECT * FROM `imprimes` WHERE `id`=$id_imprime";
        ...
        // mise à zero 0 des etapes de cet imprimé selectionné pour cette 
        // commande
        //lecture des informations de cet imprimé
...
//   position: 'bottom-start',
  ...
  timer: 3000
        ...
        <script>travail()</script>  -->
        <?php
        //die();        
        header("Location: ./indexcommande.php?page=1");
        //header( "refresh:3;url=./indexcommande.php?page=1" );
        die();
