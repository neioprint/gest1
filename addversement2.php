                ...
                <?php if (isset($_POST["client1"])) { ?>
                    <form name="fo" method="post">
                        <div class="form-group">
                            <label for="solde">Solde avant operation</label>
                            <input type="number" id="solde" name="solde" value="<?= $_SESSION["solde"] ?>" class="form-control" readonly>
                        </div>
