  ...
  < ?php   } ?> -->
    ...
    <!-- < ?php
      ...
      if(isset($_POST['button1'])) {
          echo "<div>This is Button1 that is selected</div>";
      }
    ...
    <div class="tab table-responsive-sm table-striped">
        ...
        <table class="table">
            ...
            <form name="fo10" method="post">
                <input class="btn btn-success" type="submit" name="v1" value="+" />

                <input class="btn btn-success" type="submit" name="v2" value="-" />
            </form>
