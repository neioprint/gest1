...
if (isset($_POST["submit1"])) {
    ...
    if (
        ...
        $etat="erreur";
        if ($_POST["quefaire"] =="commandenouv") $etat="0/En Attente ".date('Y-m-d'). " à ".date('H:i'). " par " . $_SESSION['login'];
        if ($_POST["quefaire"] =="proforma") $etat="6/Proforma ".date('Y-m-d'). " à ".date('H:i'). " par " . $_SESSION['login'];
        //print_r($_POST["etat"]);
        $etatseq = "";
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="commandes" name="commandes" required>
                        ...
                        if ($nb == 0) {
                            echo "<option value='' >pas d'imprime veuillez SELECTIONNER UN AUTRE client</option>";
                        }
                        ?>
  ...
  $(this).siblings(".custom-file-label").addClass("selected").html(fileName);
    ...
    <script>
        function selection() {
            ...
            // console.log(var1);
            window.location.href = "formcommande.php?idclient=" + document.getElementById("client").value;
            //$_COOKIE["idclient"];
