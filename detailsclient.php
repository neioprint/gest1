    ...
    <main class="container">
        <div class="row">
            <section class="col-12">
                <h1 class="entete">Détails Client <?= $client['client'] ?></h1>
                <!-- <p>ID : < ?= $client['id'] ?></p>
        ...
        function envoisms() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    document.location.href = "sms/sms.php?idclient=<?= $client['id'] ?>&message=Bienvenue sur la plateforme de commande en ligne NEIO vous avez renseigné votre fiche client avec succée,veuillez soumettre votre demande";
