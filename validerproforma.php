...
if (@$_SESSION['valider'] === "non" && @$_SESSION['valider'] != "deja") {
      ...
      $sql = 'UPDATE `numero` SET `proforma`=:nbr  WHERE `id`=:id;';
      ...
      $_SESSION['message'] .= "Facture proforma Validé";
} 
else $_SESSION['message'] .= "Facture proforma Déja Validé ";
header("Location:proformaneioselection.php?valider=oui&datebl=$datebl&modepaiement=$modepaiement&nbr=$nbr");
die;
...
//       fclose($fp);
//       $_SESSION['valider'] = "oui";
//       $_SESSION['message'] = "Proforma  Validé";
// }
// header('Location: proformaneioselection.php');
// die;
