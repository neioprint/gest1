...
<!-- ******************************************  -->
                ...
                <select class="form-control" id="client" name="client" required onchange="mafonction()">
...
<!-- $$$$$$$$$$$$$$$$$$$$$$$$ Debut affiche l'imprimé selon client $$$$$$$$$$$$$$$$$$$$$$$$$ -->
            ...
            <div class="form-group">
                ...
                <?= $imprime['idclient'].'/'.$imprime['imprime'] ?>
                </option>
                <?php
                        }
                ?>
...
<!-- $$$$$$$$$$$$$$$$$$$$$$$$ Fin affiche l'imprimé selon client $$$$$$$$$$$$$$$$$$$$$$$$$ -->
                ...
                <div class="form-group">
                <label for="monfichier">Si vous avez un fichier d'impression PDF,jpg,png,convert_uuencode veuillez le charger</label> <br>
