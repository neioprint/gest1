...
<body>
    ...
    <a id="bouton" href="validerbl2.php?id=<?= $id ?>" class="btn btn-primary btn-block">Valider le Bon de livraison</a>
    <a id="bouton" href="" class="btn btn-primary btn-block">Telecharger le pdf du bon de livraison</a>
