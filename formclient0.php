...
//      die();
    ...
    if (isset($_POST["submit"])) {
        ...
        if (
            ...
            $etat="erreur";
            if ($_POST["quefaire"] =="commandenouv") $etat="0/En Attente +DIRECT+".date('Y-m-d'). " à ".date('H:i');
            if ($_POST["quefaire"] =="proforma") $etat="6/Proforma +DIRECT+".date('Y-m-d'). " à ".date('H:i');
        ...
        :prix,:prepress,:total,:remarque,:etat,:etatseq,:paiement,:images,:bc,:tag,:solde,:etapesvalidee);';
            ...
            //      print_r($query);
            $_SESSION['message'] .= 
            "Pré-Commande ajoutée avec succée. <br>
            Votre Demande est mise en attente.<br>".
            "Vous recevrez un e-mail indiquant l'etat de son avancement <br>";
          ...
          mail("neioprint@gmail.com", "Urgent Prioritaire Nouvelle Commande de $nomclient", $msg, $headers);
            ...
            header("Location: sms/sms.php?idclient=$idclient&message=$msg&direct=oui&tel=213541035548"); 
...
<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ -->
            ...
            <form id="formulaire" name="fo" method="post" enctype="multipart/form-data">
            <div class="form-group">
                   ...
                   <select class="form-control" id="quefaire" name="quefaire"  onchange="this.form.submit()">
                    ...
                    <option value="proforma" >Demander une proforma</option>
                    <option value="commandenouv">Commander</option>
                        <!-- <option value="commanderenouv">Renouveller commande</option> -->
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="client" name="client" required>
                        <option value="<?php echo ($idclientSel . '/' . $nomclient) ?>"><?php echo ($idclientSel . '/' . $nomclient) ?></option>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <a class="btn btn-primary btn-danger btn-block" href="addnouvelimprime.php?idclient=<?= $idclientSel ?>&nomclient=<?= $nomclient ?>">Ajouter l'Imprimé s'il n'est pas dans la liste</a>
                    <div>
                        <br>
                ...
                <input type="text"  class="form-control" id="prix"
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group">
                            <label for="monfichier">Fichier d'impression Faculatif (PDF,jpg,png) </label> <br>
                            <input type="hidden" name="MAX_FILE_SIZE" value="5000000" />
                            <input type="file" name="monfichier" value="monfichier" />
                            <br>
                            <label for="monfichier2">Fichier Bon de commande Faculatif (PDF,jpg,png) </label> <br>
                            <input type="hidden" name="MAX_FILE_SIZE" value="5000000" />
                ...
                <label for="paiement">A terme</label> -->
                            ...
                            <button type="submit" class="btn btn-success" name="submit" id="submit" value="Envoyer Commande" class="btn btn-success">Valider </button>
