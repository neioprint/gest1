    ...
    <main class="container">
        <div class="row">
            <section class="col-12">
                <h2 class="entete">Etats de commande</h2>
                <?php $afficher = explode("//", $commande['etatseq']);
                //print_r($afficher);
                //echo count($afficher);
                for ($i = 0; $i < count($afficher) - 1; $i++) {
                    if (($afficher[$i]) == " ") ?>
                    <input type="text" class="form-control" value="<?= $afficher[$i] ?>" readonly>
                    <br>
                <?php } ?>
                ...
                <div class="form-group">
                    <div class="radio form-group">
                        ...
                        <fieldset>
                            <legend>Etat Commande Actuel <?= $commande['etat'] ?></legend>
                            <?php if ($etatsuivi == 0) { ?>
