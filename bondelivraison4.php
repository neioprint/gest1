        ...
        <div class="stylebl">
            ...
            <div class="form-group">
                ...
                <form name="form" method="get" action="">
                    ...
                    <select class="form-control" id="idclient" name="idclient" onchange="this.form.submit()">

                        <option value="">Selectionnez un client</option>
                        <?php
                        // On boucle sur la variable result
                        // Boucle pour parcourrir la table client
                        foreach ($resultclient as $client) :

                        ?>

                            <option value="<?php
                                            // la valeur du selectionnée client est deduite en comparant avec le tableau
                                            // $resultclient (variable php) avec la valeur idclient fournie par le select
            ...
            <tbody>
                ...
                for ($i = 0; $i < $_SESSION['boucle']; $i++) : ?>
                    <tr>
                        ...
                        <td class="table-primary">
                            <input class="form-control form-control-sm classsmall" type="number" name="inputidimprime" placeholder="" value="<?php echo @$idimprime ?>" readonly />
                        </td>

                        <td class="table-warning">
                            <input type="text" class="form-control form-control-sm classsmall" name="inputimprime" placeholder="" value="<?= @$imprime ?>" readonly>
                        ...
                        <td class="table-primary">
                            <input class="form-control form-control-sm classsmall" type="number" name="inputqte" placeholder="" value="<?php echo @$quantite ?>" />

                            <!-- < ?= @$quantite ?> -->
                        </td>
                        <td class="table-primary">
                            <input class="form-control form-control-sm classsmall" type="number" name="inputprix" placeholder="" value="<?= number_format(@$prix, 2, ".", ".") ?>" />

                        </td>
                        <td class="table-primary">
                            <input class="form-control form-control-sm classsmall" type="number" name="inputprepress" placeholder="" value="<?= @$prepress ?>" />
                        </td>
                        <td class="table-danger">
                            <input class="form-control form-control-sm classsmall" type="text" name="inputtotal" value="<?= number_format(@$total, 2, ",", ".") ?>" readonly />
                        </td>
                        <!-- onfocus="this.value='< ?php echo $prepress+$quantite*$prix ?> '"  -->
